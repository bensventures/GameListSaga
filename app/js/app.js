...
;define( 'config',[], function ()
{
	return {
		...
		myGamesStorageKey : 'gamelistsaga_mygames',
		baseUrlBanner : 'http://i2.midasplayer.com/images/games/[short]/tournamentPage/[short]_764x260.jpg'
	};
} );
...
define( 'utilities/storageInterface',[
	'config'
],
	function ( config )
	{
...
define('text!templates/game-list.html',[],function () { return '<li class="list-group-item col-xs-4 col-sm-3">\n\t<a href="#game/<%= short %>">\n\t\t<img class="thumb" src="http://i1.midasplayer.com/images/games/<%= short %>/<%= short %>_60x60.gif" alt="<%= name %>" />\n\t\t<%= name %>\n\t</a>\n\t<div class="actions-edit">\n\t\t<button class="action-delete btn btn-danger icon ion-ios7-close"></button>\n\t</div>\n</li>\n';});

;
define( 'views/game-list',[
	'backbone',
	'underscore',
	'config',
...
define('text!templates/games-counter.html',[],function () { return '<span class="counter"><%= count %></span> <span class="counter-legend"><% if ( count === 1 ) { %>game<% }else{ %>games<% } %></span>';});
 ...
 */
/**
 * Customized for GameListSaga purposes. Now takes a container parameter instead of 'window'
...
define("unveil", function(){});

;
define( 'collections/search-results',[
	'config',
	'backbone',
	'models/game'
...
define('text!templates/search-list.html',[],function () { return '<% _.each( results, function( game ) { %>\n<li class="list-group-item">\n\t<img class="thumb" data-src="http://i1.midasplayer.com/images/games/<%= game.short %>/<%= game.short %>_60x60.gif" alt="<%= game.name %>" />\n\t<%= game.name %>\n\t<div class="actions">\n\t\t<a href="#preview/<%= game.short %>" class="action-preview btn icon ion-eye"></a>\n\t\t<button class="action-add btn <% if( myGames.get( game.short ) ) { %>added<% } %>" data-game-id="<%= game.short %>"><span>Add</span></button>\n\t</div>\n</li>\n<% } ); %>\n';});
...
define('text!templates/game.html',[],function () { return '<article>\n\t<header class="game-hero">\n\t\t<img src="http://i2.midasplayer.com/images/games/<%= game.short %>/tournamentPage/<%= game.short %>_764x260.jpg" alt="<%= game.name %>" />\n\t\t<h1 class="game-title"><%= game.name %></h1>\n\t</header>\n\t<section class="game-actions">\n\t\t<a href="http://www.king.com<%= game.url %>" class="btn action-play icon ion-game-controller-b">Play</a>\n\t\t<a href="#" class="btn action-delete icon ion-ios7-close<% if ( preview ) { %> softhide<% } %>">Delete</a>\n\t</section>\n</article>\n<a href="#<% if ( preview ) { %>add<% } %>" class="action-close btn icon ion-ios7-close-empty"></a>\n';});
